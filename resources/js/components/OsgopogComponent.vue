    ...
    export default {
        ...
        data() {
            return {
                ...
                fond: [
                    {text: 'до 2.5 тонн', value: '2.5'},
                    {text: 'до 5 тонн', value: '5'},
                    {text: 'до 7.5 тонн', value: '7.5'},
                    {text: 'до 10 тонн', value: '10'},
                    {text: 'до 12.5 тонн', value: '12.5'},
                    {text: 'до 15 тонн', value: '15'},
                    {text: 'до 20 тонн', value: '20'},
                    {text: 'Свыше 20 тонн', value: '100'},
                ],
                period: [
